        ...
        >
          <div className='flex-1 text-white relative'>
            <div className='absolute top-0 left-0 w-full h-full'>
              {/* Close button */}
              <div className='absolute top-3 ph_sm:top-6 left-3 ph_sm:left-6 z-10 w-8 h-8 bg-black rounded-full flex items-center justify-center hover:cursor-pointer'>
                <IoCloseSharp onClick={handleClickClose} className='text-lg' />
              </div>

              {/* Toggle fullscreen button */}
              <div className='absolute top-3 ph_sm:top-6 right-3 ph_sm:right-6 z-10 w-8 h-8 bg-black rounded-full hidden lg:flex items-center justify-center hover:cursor-pointer'>
                {!isFullScreen ? (
                  <AiOutlineDoubleRight
          ...
          <div className='h-14 text-white flex items-center justify-center'>
            <div className='w-[90%] ph:w-[80%] md:w-[65%] lg:w-1/2 h-full flex items-center justify-between'>
              {/* Reply button */}
              <div
                title='Reply'
